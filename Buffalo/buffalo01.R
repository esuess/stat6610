# An example from the rvest website.
...
# The example modified to work with the Buffalo, NY webpage.
...
# Expanding the example to download the data for 3 days.
...
# Now generalize the code to download the data for each day of 2016, note leap year.
...
# Now create the dates for each day of the year and merge it with the daily average tempurature data.
